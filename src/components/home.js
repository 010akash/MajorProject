...
const Home=()=>{
    return(
        ...
        <svg className="homeBorder" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#041e55" fill-opacity="1" d="M0,0L80,21.3C160,43,320,85,480,96C640,107,800,85,960,106.7C1120,128,1280,192,1360,224L1440,256L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
        </svg>
        </>
    );
}
