...
const Header = () =>{
    ...
    return(
        <div className="navBar">
            <div className="logo">
               <Link to="/" style={{textDecoration:'none',color:'#041e55'}} className="logoLink">Akash Thakur</Link>
            </div>
            <div>
                <ul className="nav-list">
                    ...
                    <li>
                    <Link to="/projects" style={{textDecoration:'none'}}>My Work</Link>
                    </li>
                    <li>
            ...
            <div>
                <button className="navBtn" style={{textDecoration:'none'}} onClick={downloadResume}>
